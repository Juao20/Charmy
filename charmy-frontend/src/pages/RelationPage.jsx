...
import { getRelation, getJournal } from '../api/relations'
              ...
              <Card key={entry.id}>
                <div className="flex items-start gap-3">
                  <span className="text-lg">
                    {EVENT_LABELS[entry.event_type]?.split(' ')[0]}
                  </span>
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-charmy-500 font-medium">
                        {EVENT_LABELS[entry.event_type]?.split(' ')[1]}
                      </span>
